      ...
      <section className={styles.vision_mission_section}>
        <div className={styles.vision_mission_container}>
          ...
          <div className={styles.vision_block}>
            <h2 className={styles.section_title}>Vision</h2>
          ...
          <div className={styles.mission_block}>
            <h2 className={styles.section_title}>Mission</h2>
            ...
            <div className={styles.mission_items}>
              <div className={styles.mission_item}>
                ...
                <div className={styles.mission_content}>
                  <h3 className={styles.mission_title}>정보전달 방식 구축</h3>
                  <div className={styles.mission_description}>
                    ...
                    <p>
                      산업현장의 디지털 전환을 처음 경험하는 고객들을 설득하고,
                      초기 가치를 입증하기 위해 노력합니다.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.mission_item}>
                ...
                <div className={styles.mission_content}>
                  <h3 className={styles.mission_title}>산업현장 새로운 문화</h3>
                  <div className={styles.mission_description}>
                    <p>
                    ...
                    <p>
                      ...
                      지속적인 혁신과 고객 행동 변화에 대한 질문, 이를 추진하는
                      내부 역량을 계속해서 재평가합니다.
                    </p>
                  </div>
                </div>
            ...
            <div className={styles.history_year_block}>
              ...
              <div className={styles.history_events}>
                ...
                <div className={styles.history_event}>
                  ...
                  <span className={styles.event_description}>
                    한국사회적기업진흥원, 하나파워온 혁신기업 인턴십 참여기업
                    선정
                  </span>
                </div>
                <div className={styles.history_event}>
            ...
            <div className={styles.history_year_block}>
              ...
              <div className={styles.history_events}>
                ...
                <div className={styles.history_event}>
                  ...
                  <span className={styles.event_description}>
                    벤처기업협회, 강남구 글로벌 스타트업 IR 활성화 지원사업 선정
                  </span>
                </div>
                <div className={styles.history_event}>
                ...
                <div className={styles.history_event}>
                  <span className={styles.event_date}>06월 01일~2일</span>
                  <span className={styles.event_description}>
                    2023 Nextrise 참여기업
                  </span>
                </div>
                ...
                <div className={styles.history_event}>
                  <span className={styles.event_date}>08월 03일~06일</span>
                  <span className={styles.event_description}>
                    2023 Korea Build 참여기업
                  </span>
                </div>
                <div className={styles.history_event}>
                  <span className={styles.event_date}>09월 13일~15일</span>
                  <span className={styles.event_description}>
                    2023 한국건설안전박람회 참여기업
                  </span>
                </div>
                <div className={styles.history_event}>
                  <span className={styles.event_date}>11월 22일 ~ 24일</span>
                  <span className={styles.event_description}>
            ...
            <div className={styles.history_year_block}>
              ...
              <div className={styles.history_events}>
                ...
                <div className={styles.history_event}>
                  ...
                  <span className={styles.event_description}>
                    경남창조경제혁신센터, 한국남동발전 Start-UP 서포터즈 선정
                  </span>
                </div>
                <div className={styles.history_event}>
